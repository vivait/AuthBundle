		...
		public function editAction(Request $request) {
			...
			$form = $this->createFormBuilder($obj)
					...
					'label'    => 'Groups'
			             ...
			             ->add('queues1', 'entity', array(
					'class'         => 'VivaBravoBundle:Queue',
					'property'      => $tenant_namefield,
					'multiple'      => true,
					'required'      => true,
					'label'         => 'Inbox 1',
					'attr'          => array('size' => 15),
					...
					'by_reference'  => false #USE THIS ALONG WITH A $queues->addUser($this); IN THE addQueue() FUNCTION TO TRIGGER AN UPDATE WHEN ON INVERSE SIDE
				))
			             ->add('queues2', 'entity', array(
					'class'         => 'VivaBravoBundle:Queue',
					'property'      => $tenant_namefield,
					'multiple'      => true,
					'required'      => true,
				...
				// TODO: Change to be against the users group. Allow cross tenant sending - with confirmation
			             ->add('sendtoqueues', 'entity', array(
					'class'        => 'VivaBravoBundle:Queue',
					'property'     => $tenant_namefield,
					'multiple'     => true,
					'required'     => true,
					'label'        => 'Send to Queues',
					'attr'         => array('size' => 15),
